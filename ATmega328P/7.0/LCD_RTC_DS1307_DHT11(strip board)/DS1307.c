 ...
 https://forum.arduino.cc/index.php?topic=277930.0
...
// simple, hard-coded way to set the date.
{
	...
	// DS1307 is I2C address defined at definesDS1307.h
...
//Ref) 
// 1. How to set SQW
//	https://www.arduinoslovakia.eu/blog/2017/9/ds1307-a-signal-obdlznikoveho-priebehu?lang=en
// 2. Usage of SQW - BlinkWithoutDelay timer
//	https://forum.arduino.cc/index.php?topic=277930.0
void DS1307_setSQW()
{
	I2C_WriteRegister(DS1307,CONTROL_REGISTER, 0x10); //generate 1hz square wave
	//I2C_WriteRegister(DS1307,CONTROL_REGISTER, 0x00); //Disable square wave
	_delay_ms(10);
}//DS1307_setSQWsetSQW
...
void testCountSQW()
{
	...
	if ( (DS1307_SQW_port & _BV(DS1307_SQW_bit)) == 0) 
	{
		//LCD_Line(0);
		lcd_write_instruction_4d(lcd_SetCursor | lcd_LineOne);
		lcd_write_string_4d((uint8_t *)"H");
		//LCD_Line(1);
